...
class CrosswordCreator():
    ...
    def assignment_complete(self, assignment):
        ...
        """
        return all(val in assignment for val in self.crossword.variables)
    ...
    def consistent(self, assignment):
        ...
        for var, word in assignment.items():
            # Test every value is the correct length
            if var.length != len(word):
                return False

            # Test there are no conflicts between neighboring variables
    ...
    def order_domain_values(self, var, assignment):
        ...
        """
        vals = dict.fromkeys(self.domains[var], 0)
        ...
        return sorted(list(vals.keys()), key=lambda x: vals[x])
