...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        mine_count = len(neighbors & self.mines)
        neighbors -= self.mines
        self.knowledge.append(Sentence(neighbors, count - mine_count))
        ...
        while True:
            ...
            # Any change to AI's knowledge might draw new inferences that
            # weren’t possible before. So we must repeat the process until no
            # new knowledge can be inferred.
            if conclude_count == infer_count == 0:
                return
